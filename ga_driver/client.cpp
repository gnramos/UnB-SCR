...
#define __DRIVER_CLASS__ GADriver     // put here the name of your driver class
#define __DRIVER_INCLUDE__ "ga_driver.h" // put here the filename of your driver h\\eader
