...
const int GADriver::gearUp[6]=
    {
        5000,6000,6000,6500,7000,0
    };
const int GADriver::gearDown[6]=
    {
        0,2500,3000,3000,3500,3500
    };

/* Stuck constants*/
const int GADriver::stuckTime = 25;
const float GADriver::stuckAngle = .523598775; //PI/6

/* Accel and Brake Constants*/
const float GADriver::maxSpeedDist=70;
const float GADriver::maxSpeed=150;
const float GADriver::sin5 = 0.08716;
const float GADriver::cos5 = 0.99619;

/* Steering constants*/
const float GADriver::steerLock=0.366519 ;
const float GADriver::steerSensitivityOffset=80.0;
const float GADriver::wheelSensitivityCoeff=1;

/* ABS Filter Constants */
const float GADriver::wheelRadius[4]={0.3306,0.3306,0.3276,0.3276};
const float GADriver::absSlip=2.0;
const float GADriver::absRange=3.0;
const float GADriver::absMinSpeed=3.0;

/* Clutch constants */
const float GADriver::clutchMax=0.5;
const float GADriver::clutchDelta=0.05;
const float GADriver::clutchRange=0.82;
const float GADriver::clutchDeltaTime=0.02;
const float GADriver::clutchDeltaRaced=10;
const float GADriver::clutchDec=0.01;
const float GADriver::clutchMaxModifier=1.3;
const float GADriver::clutchMaxTime=1.5;


int
GADriver::getGear(CarState &cs)
{
...
float
GADriver::filterABS(CarState &cs,float brake)
{
...
void
GADriver::clutching(CarState &cs, float &clutch)
{
